...
public class Creature extends Actor
{
     ...
     */
    /**
     * switchCreature() will the method used to help to switch the creatures in the world
     * 
     * @param the parameters will be an integer item called idx(index)
     * @return no return type
     */
    public void switchCreature(int idx)
    {
      //empty, it will be overriden by subclasses
    }
     ...
     */
    /**
     * switchedIn() will the method used to help to switch in  the creatures to the world
     * 
     * @param no param 
     * @return no return type
     */
